...
function Service() {
  ...
  const services = [
    ...
    { title: 'Permohonan Baptisan', description: 'Submit a prayer request for your needs.', img: 'https://picsum.photos/id/108/300/200' },
    { title: 'Konseling', description: 'Sundays at 9:00 AM - A dedicated time for children to learn and grow in their faith.', img: 'https://picsum.photos/id/103/300/200' },
    { title: 'Pelayan Kartu Jemaat', description: 'Assistance with church member services.', img: 'https://picsum.photos/id/104/300/200' },
