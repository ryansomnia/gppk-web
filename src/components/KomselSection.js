...
const dummyData = [
  { id: 1, name: 'Debora', category: 'Umum', day: 'Senin', time: '18:00', leader: 'Bpk. Anton S', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Cikaret' },
  { id: 2, name: 'I P K', category: 'Umum', day: 'Jumat', time: '16:00', leader: 'Ibu Sondang L', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Ciparengga' },
  { id: 3, name: 'Imanuel', category: 'Umum', day: 'Rabu', time: '19:00', leader: 'Ibu Tiarma', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Ciluar' },
  { id: 4, name: 'Sion', category: 'Umum', day: 'Rabu', time: '19:00', leader: 'Bpk. Bines', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Karadenan' },
  { id: 5, name: 'Rajawali', category: 'Umum', day: 'Selasa', time: '19:00', leader: 'Bpk. Janson S', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Kandang Roda' },
  { id: 6, name: 'Hermon', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Bpk. Rudolfo Pardede', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah BTN Ciluar' },
  { id: 7, name: 'Yobel', category: 'Umum', day: 'Kamis', time: '18:00', leader: 'Ibu Elfrida', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Bogor Asri' },
  { id: 8, name: 'Filadelfia', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Bpk. Anggiat', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Cimandala' },
  { id: 9, name: 'Kanaan', category: 'Umum', day: 'Kamis', time: '19:00', leader: 'Bpk. Endah', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Ciluar' },
  { id: 10, name: 'Pniel', category: 'Umum', day: 'Selasa', time: '19:00', leader: 'Bpk. Iwan G', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Bintang Mas' },
  { id: 11, name: 'Grace', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Bpk. S Hutapea', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Cimandala' },
  { id: 12, name: 'Agape', category: 'Umum', day: 'Kamis', time: '18:00', leader: 'Bpk. Tedy', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Tatya Asri' },
  { id: 13, name: 'Nazaret', category: 'Umum', day: 'Minggu', time: '19:00', leader: 'Bpk. Parjo', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah BTN CMDLA' },
  { id: 14, name: 'Kairos', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Bpk. Dody', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Perum CI' },
  { id: 15, name: 'Bersinar', category: 'Umum', day: 'Minggu', time: '19:00', leader: 'Ibu Yulia', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Perum Cimandala' },
  { id: 16, name: 'Lidia', category: 'Umum', day: 'Selasa', time: '18:00', leader: 'Ibu Tike', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Nirwana Estate Cikaret' },
  { id: 17, name: 'Glory', category: 'Umum', day: 'Kamis', time: '16:00', leader: 'Ibu Rita Pasaribu', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah JemPari—Progo' },
  { id: 18, name: 'Jehova Jireh', category: 'Umum', day: 'Jumat', time: '19:00', leader: 'Ibu Dessy Lestari', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Cibinong' },
  { id: 19, name: 'Daniel', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Ibu Liner S', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Kp. Serempet' },
  { id: 20, name: 'Menarah KSH', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Bpk. Mikhael Seno W', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Kopem' },
  { id: 21, name: 'Elshadai', category: 'Umum', day: 'Senin', time: '19:00', leader: 'Ibu Rosalina Sihombing', contact: '08123456789', image: '/images/komsel ilu.jpeg', area: 'Wilayah Cibinong' },
