...
const WorshipLayout = () => {
  ...
  <h3 className="text-[10px] sm:text-xl font-semibold text-white">Ibadah Raya 1</h3>
  <p className="text-[8px] sm:text-xs font-normal text-white leading-tight">Ibadah Umum setiap Minggu, Jam 09:00 WIB</p>
        ...
        <div className=" flex items-end justify-center w-1/2 h-48 md:h-1/2"
         style={{
          ...
          <div className=" text-center bg-yellow-600 py-1 px-2 m-1 rounded-lg">
  <h3 className="text-[10px] sm:text-xl font-semibold text-white">Ibadah Raya 2</h3>
  <p className="text-[8px] sm:text-xs font-normal text-white leading-tight">Ibadah Pemuda setiap Minggu, Jam 16:00 WIB</p>
</div>
        </div>
